...
const ALL_MIGRATIONS = [
  ...
  `CREATE TABLE IF NOT EXISTS students (
    ...
    phone VARCHAR(20), birthday DATE NULL, birthplace VARCHAR(120) NULL,
    address TEXT, guardian_name VARCHAR(120), guardian_phone VARCHAR(20),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
  )`,
  ...
  `CREATE TABLE IF NOT EXISTS teachers (
    ...
    department VARCHAR(80), phone VARCHAR(20),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
  )`,
  ...
  `CREATE TABLE IF NOT EXISTS classes (
    ...
    class_date DATE NOT NULL, qr_token VARCHAR(255) NULL,
    qr_expires_at TIMESTAMP NULL, attendance_open BOOLEAN NOT NULL DEFAULT FALSE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
  )`,
  ...
  `CREATE TABLE IF NOT EXISTS assignments (
    ...
    due_date TIMESTAMP NOT NULL, max_score DECIMAL(5,2) NOT NULL DEFAULT 100.00,
  ...
  `CREATE TABLE IF NOT EXISTS submissions (
    ...
    student_id INT NOT NULL REFERENCES students(id) ON DELETE CASCADE,
    file_url VARCHAR(500) NULL, file_data TEXT NULL,
    file_name VARCHAR(255) NULL, file_type VARCHAR(100) NULL, file_size INT NULL,
    text_answer TEXT NULL, score DECIMAL(5,2) NULL, feedback TEXT NULL,
    status VARCHAR(15) NOT NULL DEFAULT 'submitted' CHECK (status IN ('submitted','graded','late','missing')),
    submitted_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, graded_at TIMESTAMP NULL,
  ...
  `CREATE TABLE IF NOT EXISTS grades (
    ...
    written_works DECIMAL(5,2), performance_tasks DECIMAL(5,2),
    quarterly_assessment DECIMAL(5,2), final_grade DECIMAL(5,2),
  ...
  `CREATE TABLE IF NOT EXISTS learning_materials (
    ...
    schedule_id INT NOT NULL REFERENCES schedules(id) ON DELETE CASCADE,
    title VARCHAR(200) NOT NULL, description TEXT,
    file_url VARCHAR(500), file_type VARCHAR(20),
  ...
  `CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    action VARCHAR(100) NOT NULL, entity VARCHAR(50), entity_id INT,
    details JSONB, ip_address VARCHAR(45),
  ...
  `CREATE TABLE IF NOT EXISTS notifications (
    ...
    title VARCHAR(120) NOT NULL, body TEXT, link VARCHAR(200),
  ...
  `CREATE TABLE IF NOT EXISTS messages (
    ...
    subject VARCHAR(150), body TEXT NOT NULL,
    is_read BOOLEAN NOT NULL DEFAULT FALSE,
  ...
  `CREATE TABLE IF NOT EXISTS calendar_events (
    ...
    event_date DATE NOT NULL, end_date DATE NULL,
